				...
				<div class="3u">
					<section>
						<div class="mbox-style">
							...
							<div class="content">
								<p class="subtitle">SeaPal is an App for sailors and other water sport fanatics that support the skipper in his tasks for navigation, route planing and logbook keeping.</p>
					...
					<section>
						<div class="mbox-style">
							...
							<div class="content">
								...
								<p><ul><li>Google Maps</li><li>OpenSeaMaps</li><li>Satellite view</li></ul></p>
							</div>
							<p class="button-style2"><a href="#">More Details</a></p>
						</div>
					</section>
