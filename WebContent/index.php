	...
	<div class="5grid-layout">
		<div class="row">
			<div id="banner" class="12u">
				<div class="container"><a href="#"><img src="images/seapal_banner.jpg" alt=""></a></div>
			</div>
		</div>
	</div>
	<div id="marketing">
				...
				<div class="3u">
					<section>
						<div class="mbox-style">
							...
							<div class="content">
								<p><span class="subtitle">SeaPal</span> is an App for sailors and other water sport fanatics that support the skipper in his tasks for navigation, route planing and logbook keeping. The central view shows a map with the current position and forward line. Waypoint and ...</p>
							</div>
				...
				<div class="3u">
					<section>
						<div class="mbox-style">
							...
							<div class="content">
								<p class="subtitle">SeaPal offers the following functionality</p>
								<ul>
									<li>Google Maps</li>
									<li>OpenSeaMaps</li>
				...
				<div class="3u">
					<section>
						<div class="mbox-style">
							...
							<div class="content">
								<p class="subtitle">With extensions SeaPal offers the following functionality:</p>
							<ul>
				...
				<div class="3u">
					<section>
						<div class="mbox-style">
							...
							<div class="content">
								<ul class="style7">
									<li style="padding-top: 0em">Follow us on our <a href="https://plus.google.com/100825752167882077539/posts">Google+ Page</a></li>
									<li>See a <a href="https://plus.google.com/100825752167882077539/videos">video on SeaPal</a></li>
									<li>SeaPal in <a href="https://itunes.apple.com/us/app/seapal/id561903907?mt=8&ign-mpt=uo%3D4">iTunes</a></li>
									<li><a href="userguide.php">User Guide</a></li>
									<li><a href="about.php">About the project</li>
									<li style="border: none"><a href="http://seapal.info/images/Legend-IBN-Map.pdf">Legend of IBN Maps</a></li>
								</ul>
							</div>
